 ...
 * @author Karen
 */
public class DoceController implements Initializable {
...
@FXML
    private void guardado(ActionEvent event) {
        ...
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(Constantes.rutaCitas))){
            ...
            alert.setContentText("Nuevo cita agregado exitosamente");
    ...
    @FXML
        ...
        public void initAttributes(ObservableList<Cita> citas) {
            this.citas=citas;}
        public void initAttributes(ObservableList<Cita> citas,Cita c) {
            this.citas=citas;
            this.citaa=c;
